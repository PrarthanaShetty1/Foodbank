...
import com.example.foodbank.Adapters.SearchAdapter;
...
import static com.example.foodbank.R.id.recycler_view;
...
public class SearchResults extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String json;
        String city, preference;
        Intent intent = getIntent();
        json = intent.getStringExtra("json");
        city = intent.getStringExtra("city");
        preference = intent.getStringExtra("preference");
        TextView heading = findViewById(R.id.heading);
        String str = "Donors in " + city + " with preference " + preference;
        heading.setText(str);
        Gson gson = new Gson();
