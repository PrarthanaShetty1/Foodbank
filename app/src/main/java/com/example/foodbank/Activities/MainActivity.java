...
import com.example.foodbank.Adapters.RequestAdapter;
import com.example.foodbank.DataModels.RequestDataModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void populateHomePage() {
        ...
        StringRequest stringRequest = new StringRequest(Method.POST, Endpoints.get_requests, new Response.Listener<String>() {
            @Override
